    ...
    <ol class="main-breadcrumb">
      <li>
        <router-link to="/" style="text-decoration: none;color: #333;">
          <span class="main-breadcrumb__type--nolink">{{ $t('Media20180904.HomeTitle') }}</span>
        </router-link>
      </li>
      <li>
        <router-link to="/ResultsMedia" class="override-link-style">
          <span class="main-breadcrumb__type--nolink">{{ $t('Media20180904.UpdateList') }}</span>
        </router-link>
      </li>
      <li class="last-item">
        <span class="main-breadcrumb__type--nolink">{{ $t('Media20180904.NewsTitle') }}</span>
      </li>
    </ol>
    <!--/Main__guide-->
  </div>
    ...
    <div class="Main__content">
      <div class="heading1-v2">
        <div class="heading1-v2__inner">
          <h1 class="heading1-v2__title">{{ $t('Media20180904.NewsTitle') }}</h1>
        </div>
      </div>
      <p class="text--right">{{ $t('Media20180904.Date') }}</p>

      <p class="text">
        {{ $t('Media20180904.NewsConL1') }}
      </p>
      <div class="column generator-column-v3" data-col-pc="2" data-col-sp="1">
        <div class="column__item item__text">
          <p class="text" style="padding-top: 30px;">
            {{ $t('Media20180904.NewsConL2') }}
          </p>
          <p class="text">
        {{ $t('Media20180904.NewsConL3') }}
          </p>
        </div>
      ...
      <div class="heading2">
        <div class="heading2__inner">
          <h2 class="heading2__title">{{ $t('Media20180904.NewsIn') }}</h2>
        </div>
      </div>
      <h3 class="AboutText">
        <p>{{ $t('Media20180904.NewsAboutText') }}</p>
        <a href="https://graphisoft.com/jp/event-report/201809_ac22_launch" target="_blank" rel="noopener"
          class="util-link--blank">
          <span class="util-bold">{{ $t('Media20180904.NewsText1') }}</span>
        </a>
      </h3>
        ...
        <div class="button-v2">
          <router-link to="/ResultsMedia">
            <a href="" class="button-v2__type">
              <span class="button-v2__label">{{ $t('Media20180904.ListBack') }}</span>
            </a>
          </router-link>
        </div>
      </div>

    ...
    <div class="Main__content">
      <div class="heading1-v2">
       <div class="heading1-v2__inner">
        <h1 class="heading1-v2__title">AI Structureがリリースされました</h1>
       </div>
      </div>
      <p class="text--right">2023年11月24日</p>

      <p class="text">
        構造担当者・積算者・作業所担当者必見！！<br>
        </p>
      <div class="column generator-column-v3" data-col-pc="2" data-col-sp="1">
        <div class="column__item item__text">
        <p class="text" style="padding-top: 30px;">「AI Structure」をリリースしました。</p>
          <li class="text">構造部材リストを積算ソフトや、BIM関連ソフトに転記する作業は多いものだと <br>1～3日ほどかかっていました。</li>
          <li class="text">AI Structureを30分から１時間程度に作業を効率化します。</li>
        </div>
        ...
        src="https://www.youtube.com/embed/FjF6f6ZqfHE" 
        ...
        <h3 class="AboutText">
          <a href="https://us-factory.jp/wp-content/uploads/2023/11/AIS%E3%83%8F%E3%82%9A%E3%83%B3%E3%83%95%E3%83%AC%E3%83%83%E3%83%882024-2.pdf" target="_blank" rel="noopener" class="util-link--blank">
          <span class="util-bold"> AIS2024パンフレットはこちら</span>
        </a>
      </h3>

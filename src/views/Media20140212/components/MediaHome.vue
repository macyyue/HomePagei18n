        ...
        <div class="Main__guide">
          <ol class="main-breadcrumb" >
            <li >
              ...
              <span class="main-breadcrumb__type--nolink">{{ $t('Media20140212.HomeTitle') }}</span>
               </router-link>
            </li>
            <li>
              <router-link to="/ResultsMedia" class="override-link-style">
              <span class="main-breadcrumb__type--nolink">{{ $t('Media20140212.UpdateList') }}</span>
            </router-link>
            </li>
            <li class="last-item">
              <span class="main-breadcrumb__type--nolink">{{ $t('Media20140212.NewsTitle') }}</span>
            </li>
          </ol>
          <!--/Main__guide-->
        </div>
    ...
    <div class="Main__content">
      <div class="heading1-v2">
       <div class="heading1-v2__inner">
        <h1 class="heading1-v2__title">{{ $t('Media20140212.NewsTitle') }}</h1>
       </div>
      </div>
      <p class="text--right">{{ $t('Media20140212.Date') }}</p>
       
      <div class="column__item item__text">
        <p class="text" style="padding-top: 30px;">
          {{ $t('Media20140212.NewsConL1') }}
        </p>
        </div>
      <div class="column generator-column-v3" data-col-pc="1" data-col-sp="1" style="text-align: center;">
        ...
        <div class="item-image">
            <img src="@/assets/image/Media20140212/img1.jpg" alt="" >
            <p class="text-title">{{ $t('Media20140212.NewsConTit') }}</p>
        </div>
        </figure>
        </div>
        </div>
        ...
        <div class="heading2">
          ...
          <h2 class="heading2__title">{{ $t('Media20140212.NewsIn') }}</h2>
         </div>
        </div>
        <h3 class="AboutText">
          <p>{{ $t('Media20140212.NewsTextAbout') }}</p>
          <a href="https://xtech.nikkei.com/kn/article/it/column/20140207/650889/" target="_blank" rel="noopener" class="util-link--blank">
          <span class="util-bold">{{ $t('Media20140212.NewsText1') }}</span>
        </a>
      </h3>
      <div class="button-wrap" data-col-pc="1" data-col-sp="1">
          <div class="button-v2">
            ...
            <a href="" class="button-v2__type">
              <span class="button-v2__label">{{ $t('Media20140212.ListBack') }}</span>
            </a>
          </router-link>
          </div>
        </div>

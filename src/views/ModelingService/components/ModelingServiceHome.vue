...
<template>
  ...
  <div class="Main__body">
    <div class="Main__content">
      <div class="heading1-v2">
       <div class="heading1-v2__inner">
        <h1 class="heading1-v2__title">高精度3D計測サービス</h1>
       </div>
      </div>
    ...
    <div class="column generator-column-v3" data-col-pc="2" data-col-sp="1">
        ...
        <div class="AboutText">
          <a href="https://www.youtube.com/watch?v=_YZeWCFbLnk" target="_blank" rel="noopener" class="util-link--blank">
          <span class="util-bold"> 急傾斜地敷地計測サービス</span>
        </a>
      </div>
      <div class="AboutText">
        <a href="https://www.youtube.com/watch?v=BSIhGZ31zEE" target="_blank" rel="noopener" class="util-link--blank">

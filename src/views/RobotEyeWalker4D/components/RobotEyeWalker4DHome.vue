      ...
      <div class="heading2__inner">
        ...
        <ul class="sol_environment__list type01">
              <li>
                  <div class="ph">
                    <iframe width="584" height="390" 
                        src="https://www.youtube.com/embed/4nMstlBqSiM" 
              ...
              <li>
                ...
                <div class="ph">
                  <iframe width="584" height="390" 
                      src="https://www.youtube.com/embed/PYFpJoS3KSc" 
                      title="YouTube video player" 
                      frameborder="0" 
                      allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" 
                      allowfullscreen="">
              ...
              <li>
                  <div class="ph">
                      <iframe width="584" height="390" 
                        src="https://www.youtube.com/embed/yD_M6P0JUVk" 
                        title="YouTube video player" 
                        frameborder="0" 
                        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" 
                        allowfullscreen="">
              ...
              <li>
                  ...
                  <div class="ph">
                    <iframe width="584" height="390" 
                        src="https://www.youtube.com/embed/Ml4qbKVx7LM" 
                        title="YouTube video player" 
                        frameborder="0" 
                        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" 
                        allowfullscreen="">
...
.sol_environment__list.type01 li:nth-child(odd) {
    margin-left: 0;
}
.sol_environment__list.type01 li {
    width: 49.91667%;
    margin-left: .1667%;
    list-style-type: none;
}
.sol_environment__list.type01 li a {
    display: flex;
    flex-direction: column;
    height: 100%;
    
}
.sol_environment__list li  a:link, a:visited {
    color: #333;
    text-decoration: none;
}
a {
...
.sol_environment__list.type01 .title {
    margin-bottom: 18px;
    padding-bottom: 15px;
...
.sol_environment__list.type01 .body {
    flex-grow: 1;
    padding: 22px 24px;
